# Release Notes - v3.x Series

This document contains release notes for the v3.x series.
...
For release notes prior to v3.8.0, see [docs/release-notes/CHANGELOG-3.7.md](docs/release-notes/CHANGELOG-3.7.md)
